                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="upload/${bookSelect.image}" alt="">
                                <div class="zoom-icon">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                <div class="pd-title">
                                    <span>${bookSelect.bookCompany}</span>
                                    <h3>${bookSelect.bookName}</h3>
                                ...
                                <div class="pd-desc">
                                    <p>${bookSelect.bookContent}</p>
                                    <h4>${bookSelect.bookPrice} <span></span></h4>
                                </div>
